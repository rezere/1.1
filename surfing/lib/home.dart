          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final imageUrl =
                    '${GetServer()}/uploads/rental/${rental['RentalID']}_1.jpg'; // Укажите точный путь к изображению
                return InkWell(
                  // Используем InkWell для обработки нажатий
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                  ...
                  child: Card(
                    // Для визуального выделения каждого элемента списка
                    child: Row(
