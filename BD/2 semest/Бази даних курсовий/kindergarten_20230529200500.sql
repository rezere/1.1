...
INSERT INTO `groups` VALUES ('Барвінок',2,1,3,'Вечірня',5),('Березка',25,1,3,'Вечірня',7),('Веселк',25,3,6,'Денна',1),('Волошко',3,1,3,'Вечірня',8),('Пролісок',1,1,3,'Вечірня',7),('Сонечко',21,1,3,'Денна',2);
...
INSERT INTO `kindergartener` VALUES (1,'Іванюк','Іванна','Іванівна','2000-10-12','Петрова 2','0967801450','2023-04-09'),(2,'Петрова','Анна','Ивановна','1970-10-05','Беля 33/5','0991337174','2015-04-09'),(5,'Сидоренко','Светлана','Сергеевна','1981-08-24','Шолохова 2/130','0501235698','2000-04-09'),(6,'Панасюк','Ірина','Віталіївна','1964-04-18','Добробут 5/8','0971228476','2023-04-09'),(7,'Сватова','Ірина','Василівна','1990-05-13','Пушкіна 8/9','0961785209','2015-04-18'),(8,'Іванова','Олеся','Іванівна','1999-03-14','вул.Пастера 4.','0981702423','2023-05-17'),(9,'Тест','Тест','Тест1','2000-06-12','Тест','0961758487','2023-05-24');
...
-- Dump completed on 2023-05-29 20:05:01
